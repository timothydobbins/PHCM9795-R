...
We will create a project called **PHCM9795** to store all the data you will use and scripts that you will write in this course. Think about where you want to store your project folder. This could be in your *Documents* folder, or a OneDrive folder.
