...
We will create a project called **PHCM9795** to store all the data you will use and scripts that you will write in this course.

Step 1: Think about where you want to store your project folder. This could be in your *Documents* folder, or a OneDrive folder.

Step 2: Choose **File \> New Project...** in RStudio to open the **Create Project** dialog
