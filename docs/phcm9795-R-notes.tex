...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4384}}
...
2 - Install the package \texttt{skimr} using \textbf{Tools \textgreater{} Install packages}, or by typing into the console:
...
\NormalTok{pbc }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\StringTok{"data/examples/pbc.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Well, this isn't correct! Note that stage is a categorical variable, that has been entered using the numbers 1 to 4. By default, the \texttt{plot()} function will plot any numerical variable on the y-axis against its position (row number) on the x-axis (labelled `Index'). To plot a categorical variable using a bar graph, we first need to define it as a factor:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Convert stage to a factor}
\NormalTok{pbc}\SpecialCharTok{$}\NormalTok{stage }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(pbc}\SpecialCharTok{$}\NormalTok{stage, }
...
\includegraphics{phcm9795-R-notes_files/figure-latex/unnamed-chunk-39-1.pdf}
...
\includegraphics{phcm9795-R-notes_files/figure-latex/unnamed-chunk-46-1.pdf}
...
\includegraphics{phcm9795-R-notes_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\includegraphics{phcm9795-R-notes_files/figure-latex/unnamed-chunk-55-1.pdf}
...
\includegraphics{phcm9795-R-notes_files/figure-latex/unnamed-chunk-56-1.pdf}
...
\includegraphics{phcm9795-R-notes_files/figure-latex/unnamed-chunk-61-1.pdf}
...
\includegraphics{phcm9795-R-notes_files/figure-latex/unnamed-chunk-61-2.pdf}
