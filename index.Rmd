...
-   Included instructions for creating two-way tables using the `contTables()` function in the `jmv` package
...
-   Explicit instructions to install `jmv` and `summarytools` when working in Module 1

[Changed]

-   Changed location of `pbc.dat` from `examples` to `activities` folder for consistency

#### 2022-05-15 - Initial release
